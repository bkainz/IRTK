...
IF (ZLIB_FOUND OR (ZLIB_LIBRARY AND ZLIB_INCLUDE_DIR))
  ADD_DEFINITIONS(-DHAS_ZLIB -DHAVE_ZLIB)
  INCLUDE_DIRECTORIES(${ZLIB_INCLUDE_DIR})
  LINK_LIBRARIES(${ZLIB_LIBRARIES})
ELSE (ZLIB_FOUND OR (ZLIB_LIBRARY AND ZLIB_INCLUDE_DIR))
  message("zlib NOT found")
ENDIF (ZLIB_FOUND OR (ZLIB_LIBRARY AND ZLIB_INCLUDE_DIR))
